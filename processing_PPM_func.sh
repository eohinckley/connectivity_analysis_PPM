...
${hcppipe}/fMRIVolume/GenericfMRIVolumeProcessingPipeline.sh --path=${hcpdir} --subject=${sub} --fmritcs=${preprocdir}/lomo_proc_func/_${sub}/merged_func.nii.gz --fmriname=rest --fmrires=2 --biascorrection=NONE --dcmethod=NONE --gdcoeffs=NONE --processing-mode=LegacyStyleData
